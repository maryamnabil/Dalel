...
@Component({
  ...
  templateUrl: './cr-rejected.component.html',
  styleUrls: ['./cr-rejected.component.scss'],
})
export class CrRejectedComponent implements OnInit {
  tableConfig: TableConfigItem[] = [
    ...
    },
    {
      ...
      value: (data) => data?.cr?.rejectionReason,
    },
    {
