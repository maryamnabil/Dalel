...
@Component({
  selector: 'app-suspended-projects',
  standalone: true,
  imports: [
  ...
  templateUrl: './suspended-projects.component.html',
  styleUrls: ['./suspended-projects.component.scss'],
})
export class SuspendedProjectsComponent implements OnInit {
