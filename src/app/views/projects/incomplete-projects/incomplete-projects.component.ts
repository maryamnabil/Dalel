...
@Component({
  selector: 'app-incomplete-projects',
  standalone: true,
  imports: [
  ...
  templateUrl: './incomplete-projects.component.html',
  styleUrls: ['./incomplete-projects.component.scss'],
})
export class IncompleteProjectsComponent implements OnInit {
